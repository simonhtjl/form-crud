...
<body>
    ...
    <div class="container-fluid">
        ...
        @csrf
            ...
            <div class="clearfix">
                <label class="float-left form-check-label"><input type="checkbox" id="remember_me "name="remember_me" value="remember_me"> Remember me</label>
                <a href="/lupapassword" class="float-right">Forgot Password?</a>
            </div>        
        </form>
        </div>
    </div>
